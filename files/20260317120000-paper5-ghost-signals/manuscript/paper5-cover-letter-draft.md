# Paper 5 Cover Letter Draft

**To**: Editor, Ecology Letters
**Re**: Manuscript submission — "Ghost signals in phenological records: Delayed first-detection dates reveal widespread population declines of Japanese insects and amphibians"

---

Dear Editor,

We are pleased to submit our manuscript "Ghost signals in phenological records" for consideration as an Article in Ecology Letters.

**Why this paper matters**: Phenological records are among ecology's most valuable long-term datasets, yet their interpretation assumes that changes in first-detection dates reflect true phenological shifts. We demonstrate that this assumption fails when populations are declining: reduced abundance decreases detection probability, producing apparent delays that we term "ghost signals." Using 67 years of standardized Japanese monitoring data (1953–2020), we provide the first multi-taxon, long-term empirical validation of this theoretical prediction.
...
We confirm that this manuscript has not been published previously and is not under consideration elsewhere.
